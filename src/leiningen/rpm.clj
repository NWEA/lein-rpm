...
(defn rpm
  "Create an RPM"
  [{{:keys [summary name copyright group mappings prefix preinstall postinstall preremove postremove requires provides conflicts workarea version release]} :rpm} & keys]
