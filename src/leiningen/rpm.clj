...
(defn rpm
  "Create an RPM"
  [{{:keys [summary copyright distribution name group packager mappings prefix preinstall postinstall preremove postremove requires provides conflicts workarea]} :rpm :keys [version]} & keys]
